...
export function runTestSet1() {
  ...
  T.remove(0);
  console.log(
    "Removed node 0 with one right child and no left child:",
    T.toString()
  );
  // remove node with one left child and no right child
  T.remove(67);
  console.log(
    "Removed node 67 with one left child and no right child:",
    T.toString()
  );
  ...
  T.remove(7);
  console.log(
    "Removed root 7 and with replacement 5 having a left child:",
    T.toString()
  );
